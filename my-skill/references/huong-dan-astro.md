...
### Cách 1: Gọi API trên Server (Frontmatter) - _KHUYÊN DÙNG_
...
<form
  id="contact-form"
  class="flex flex-col gap-4 p-6 border rounded-lg max-w-md"
>
  <div>
  ...
  <button
    type="submit"
    class="bg-yellow-400 font-bold py-2 rounded hover:bg-yellow-500 transition-colors"
  >
    Gửi thông tin
  </button>
...
_Trong file React component (`WeatherWidget.jsx`):_

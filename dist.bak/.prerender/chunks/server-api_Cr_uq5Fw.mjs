...
const $$ServerApi = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${renderComponent(
      ...
      "Layout",
      $$Layout,
      { title: "Server API Demo | LuxiArc" },
      {
        default: async (
          $$result2
        ) => renderTemplate` ${maybeRenderHead()}<section class="space-y-5"> <p class="text-sm font-semibold uppercase tracking-widest text-blue-600">Server Fetch</p> <h1 class="text-3xl font-bold">Demo gọi API ở server (Astro frontmatter)</h1> <p class="text-slate-600">

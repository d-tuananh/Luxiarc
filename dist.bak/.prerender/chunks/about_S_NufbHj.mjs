...
const $$About = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$About;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "About | LuxiArc" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="space-y-4"> <h1 class="text-3xl font-bold">About Page</h1> <p class="max-w-2xl text-slate-600">
...
}, "D:/code/Work_tech_5s/astrojs/thi-cong-luxiarc/src/pages/about.astro", void 0);

const $$file = "D:/code/Work_tech_5s/astrojs/thi-cong-luxiarc/src/pages/about.astro";
const $$url = "/about";

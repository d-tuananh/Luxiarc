...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Home | LuxiArc" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="space-y-4 container"> <p class="text-sm font-semibold uppercase tracking-widest text-blue-600">Astro Demo</p> <h1 class="text-4xl font-bold">Trang chủ mẫu với LuxiArc</h1> <p class="max-w-2xl text-slate-600">
...
}, "D:/code/Work_tech_5s/astrojs/thi-cong-luxiarc/src/pages/index.astro", void 0);

const $$file = "D:/code/Work_tech_5s/astrojs/thi-cong-luxiarc/src/pages/index.astro";
const $$url = "";
